...
Está basado en nuestro tour de Cayos Holandeses — ya el arrecife más remoto y mejor conservado de San Blas, con su propia hora de salida más temprana y tamaño mínimo de grupo — combinado con una estadía nocturna para que también puedas cubrir el arrecife del barco hundido de Perro Chico sin apretar ambos en un solo día. Como está armado para personas ya familiarizadas con lo básico del snorkel, mantenemos el grupo más pequeño y pasamos más tiempo en el agua en vez de dividir el día en muchas paradas cortas.

## Antes de reservar

Dinos el nivel de comodidad de tu grupo en mar abierto y si alguien necesita equipo (máscara/aletas) o trae el suyo — Cayos Holandeses implica un trayecto en lancha más largo que las islas más cercanas, así que vale la pena confirmar que todos están de acuerdo antes de fijar fechas.
