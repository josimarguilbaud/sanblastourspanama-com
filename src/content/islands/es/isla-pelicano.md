...
## Por qué es una parada premium

Como está más alejada del punto de embarque en el continente, Isla Pelícano suele aparecer en itinerarios VIP o privados en vez de pasadías económicos estándar — el tiempo extra en lancha vale la pena para viajeros que quieren una isla más tranquila con excelente snorkel y, por supuesto, la foto.

## Bueno saberlo

- **Ideal para:** fans de La Casa de Papel, fotógrafos, viajeros en un tour VIP o privado con más tiempo de lancha dentro del día.
- **Facilidades:** mínimas — es una parada escénica y de snorkel, no una isla con infraestructura para pasar el día.
- **Distancia:** más lejos de Cartí que la mayoría de las islas de pasadía estándar, por lo que suele combinarse con itinerarios premium o privados que permiten más tiempo en el agua.
