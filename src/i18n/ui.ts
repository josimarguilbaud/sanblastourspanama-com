...
export const ui: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.faq': 'FAQ',
    'nav.menu': 'Menu',
    'cta.book': 'Message Us on WhatsApp',
  ...
  es: {
    ...
    'nav.menu': 'Menú',
    'cta.book': 'Escríbenos por WhatsApp',
  ...
  de: {
    ...
    'nav.faq': 'FAQ',
    'nav.menu': 'Menü',
    'cta.book': 'Per WhatsApp Schreiben',
  ...
  fr: {
    ...
    'nav.faq': 'FAQ',
    'nav.menu': 'Menu',
    'cta.book': 'Écrivez-nous sur WhatsApp',
  ...
  'pt-br': {
    ...
    'nav.faq': 'FAQ',
    'nav.menu': 'Menu',
    'cta.book': 'Fale Conosco no WhatsApp',
